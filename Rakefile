namespace :book do
    ...
    task :build do
      ...
      begin
        ...
        `bundle exec asciidoctor #{params} -a data-uri qucs_s_docs.adoc`
        puts " -- HTML output at qucs_s_docs.html"
  
        puts "Converting to EPub..."
        `bundle exec asciidoctor-epub3 #{params} qucs_s_docs.adoc`
        puts " -- Epub output at qucs_s_docs.epub"
  
       # puts "Converting to Mobi (kf8)..."
       # `bundle exec asciidoctor-epub3 #{params} -a ebook-format=kf8 qucs_s_docs.adoc`
       # puts " -- Mobi output at qucs_s_docs.mobi"
  
        puts "Converting to PDF... (this one takes a while)"
        `bundle exec asciidoctor-pdf #{params} qucs_s_docs.adoc 2>/dev/null`
        puts " -- PDF output at qucs_s_docs.pdf"
